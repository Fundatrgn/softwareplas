	...
	var OriXy = {
		...
		Basic: {
			init: function() {
				...
				try { this.preloader(); } catch(e) { console.error("preloader init hatasi:", e); }
				try { this.BackgroundImage(); } catch(e) { console.error("BackgroundImage init hatasi:", e); }
				try { this.Animation(); } catch(e) { console.error("Animation init hatasi:", e); }
				try { this.StickyHeader(); } catch(e) { console.error("StickyHeader init hatasi:", e); }
				try { this.OnePageNavJs(); } catch(e) { console.error("OnePageNavJs init hatasi:", e); }
				try { this.MobileMenu(); } catch(e) { console.error("MobileMenu init hatasi:", e); }
				try { this.searchPopUp(); } catch(e) { console.error("searchPopUp init hatasi:", e); }
				try { this.scrollTop(); } catch(e) { console.error("scrollTop init hatasi:", e); }
				try { this.counterUp(); } catch(e) { console.error("counterUp init hatasi:", e); }
				try { this.TwinMax(); } catch(e) { console.error("TwinMax init hatasi:", e); }
				try { this.MainSLider(); } catch(e) { console.error("MainSLider init hatasi:", e); }
				try { this.SponsorSlider1(); } catch(e) { console.error("SponsorSlider1 init hatasi:", e); }
				try { this.SponsorSlider2(); } catch(e) { console.error("SponsorSlider2 init hatasi:", e); }
				try { this.TestimonialSlider1(); } catch(e) { console.error("TestimonialSlider1 init hatasi:", e); }
				try { this.BlogFeedSlider(); } catch(e) { console.error("BlogFeedSlider init hatasi:", e); }
				try { this.MainBanner2(); } catch(e) { console.error("MainBanner2 init hatasi:", e); }
				try { this.TextScroll(); } catch(e) { console.error("TextScroll init hatasi:", e); }
				try { this.SreenshootSlider(); } catch(e) { console.error("SreenshootSlider init hatasi:", e); }
				try { this.bannerParalax(); } catch(e) { console.error("bannerParalax init hatasi:", e); }
				try { this.BlogSlide(); } catch(e) { console.error("BlogSlide init hatasi:", e); }
				try { this.ServicesCarousel7(); } catch(e) { console.error("ServicesCarousel7 init hatasi:", e); }
				try { this.SocialRattingSlider(); } catch(e) { console.error("SocialRattingSlider init hatasi:", e); }
				try { this.CircleProgress(); } catch(e) { console.error("CircleProgress init hatasi:", e); }
				try { this.ShopPriceFilter(); } catch(e) { console.error("ShopPriceFilter init hatasi:", e); }
				try { this.ShopDetailsJs(); } catch(e) { console.error("ShopDetailsJs init hatasi:", e); }
				try { this.SkillProgress(); } catch(e) { console.error("SkillProgress init hatasi:", e); }
				try { this.LandingBanner(); } catch(e) { console.error("LandingBanner init hatasi:", e); }
				try { this.InnerPageSlide(); } catch(e) { console.error("InnerPageSlide init hatasi:", e); }
				try { this.LandingTestimonial(); } catch(e) { console.error("LandingTestimonial init hatasi:", e); }
				try { this.AgencyMainBanner(); } catch(e) { console.error("AgencyMainBanner init hatasi:", e); }
				try { this.AgencySponsorSlider(); } catch(e) { console.error("AgencySponsorSlider init hatasi:", e); }
				try { this.AgencyProjectSlider(); } catch(e) { console.error("AgencyProjectSlider init hatasi:", e); }
			...
			MainSLider: function (){
				$('.ori-slider-wrap-1').slick({
					...
					fade: true,
					autoplay: true,
					autoplaySpeed: (typeof window.oriSliderSpeed !== 'undefined') ? window.oriSliderSpeed : 6000,
					pauseOnHover: true,
					slidesToScroll: 1,
