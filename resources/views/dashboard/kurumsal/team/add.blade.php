    ...
    <div class="page-content-wrapper">
        ...
        <div class="page-content">
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3">Hakkımızda Ekle</div>
                <div class="ps-3">
                ...
                <div class="col-xl-9 mx-auto">
                    <div class="card">
                        <div class="card-body p-4">
                            <form class="row g-3 needs-validation" action="/admin/ekibimiz/add" method="POST" validate
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" class="form-control" id="bsValidation3" name="name"
                                        placeholder="Başlık" required value="{{ $data->name ?? '' }}">
                                </div>
                                <div class="col-md-12">
                                    <label for="bsValidation3" class="form-label">Unvan</label>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="bsValidation10" name="linkedin"
                                        placeholder="Alt Başlık" required value="{{ $data->linkedin ?? '' }}">
                                </div>
                                <div class="col-md-6">
