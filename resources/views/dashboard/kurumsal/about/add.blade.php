                ...
                <div class="col-xl-9 mx-auto">
                    <div class="card">
                        <div class="card-body p-4">
                            ...
                            @endif
                            <form class="row g-3 needs-validation" action="/admin/hakkimizda/add" method="POST" validate
                                ...
                                <div class="col-md-12">
                                    <label for="bsValidation10" class="form-label">Alt Başlık</label>
                                    <input type="text" class="form-control" id="bsValidation10" name="subtitle"
                                        placeholder="Alt Başlık" required value="{{ $data->subtitle ?? '' }}">
                                </div>
                                @isset($data)
                                    @if ($data->image)
                                        <div class="col-md-12">
