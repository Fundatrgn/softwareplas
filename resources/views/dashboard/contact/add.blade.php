                    ...
                    <div class="card">
                        <div class="card-body p-4">
                            <form class="row g-3 needs-validation" action="#" method="POST" validate
                                ...
                                <div class="col-md-6">
                                    <label for="bsValidation3" class="form-label">Konu</label>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea type="text" class="form-control" disabled id="mesaj" rows="8" name="content" placeholder="Açıklama">{{ $data->content ?? '' }}</textarea>
                                </div>
