    ...
    <div class="page-content-wrapper">
        ...
        <div class="page-content">
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3">Tarihçe</div>
                <div class="ps-3">
                ...
                <div class="ms-auto">
                    <div class="btn-group">
                        <a href="/admin/tarihce/add" class="btn btn-outline-primary">Yeni Ekle</a>
                    </div>
                </div>
            </div>
            <div class="card">
                            ...
                            <tbody>
                                @foreach ($data as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="/admin/tarihce/add/{{ $item->id ?? '' }}" class="text-warning"
                                            ...
                                            <a href="/admin/tarihce/del/{{ $item->id ?? '' }}" class="text-danger"
                                                data-bs-toggle="tooltip" data-bs-placement="bottom" title=""
