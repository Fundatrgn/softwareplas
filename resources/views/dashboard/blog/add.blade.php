    ...
    <div class="page-content-wrapper">
        ...
        <div class="page-content">
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3">Blog Ekle</div>
                <div class="ps-3">
                ...
                <div class="col-xl-9 mx-auto">
                    <div class="card">
                        <div class="card-body p-4">
                            ...
                            @endif
                            <form class="row g-3 needs-validation" action="/admin/blog/add" method="POST" validate
                                ...
                                <div class="col-md-12">
                                    <label for="bsValidation3" class="form-label">Özet</label>
                                    <input type="text" class="form-control" id="bsValidation3" name="summary"
                                        placeholder="Özet" required value="{{ $data->summary ?? '' }}">
                                </div>
                                <div class="col-md-12">
                                    ...
                                    <select name="category_id" id="" class="form-control">
                                        ...
                                        @foreach ($categories as $category)
                                            @if (isset($data) && $category->id == $data->category_id)
                                ...
                                <div class="col-md-6">
                                    <label for="bsValidation10" class="form-label">Hashtag</label>
                                    <input type="text" class="form-control" id="bsValidation10" name="tags"
                                        placeholder="tag1,tag2,tag3" required value="{{ $data->tags ?? '' }}">
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-12">
                                    <label for="bsValidation5" class="form-label">İçerik</label>
