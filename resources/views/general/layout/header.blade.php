...
<head>
    ...
    <!-- Marya Tipografi: Montserrat (ana yazı tipi) + Cormorant Garamond (vurgu)
         Fontlar kendi sunucumuzda barındırılıyor (bkz. global.css @font-face);
         Google Fonts CDN'ine bağımlılık kaldırıldı — bazı sunucu/ağ
         ortamlarında bu CDN'e erişim engellenebiliyor ve font hiç
         yüklenmiyordu. -->
